<template>
  <section>
    <h1 class="text-5xl font-bold mt-20">Hello, I'm Djuro Spirov</h1>
    <p class="text-base text-grey-900 p-2 italic">Vue dev</p>
  </section>
  <section class="flex flex-col md:flex-row">
    ...
    <img src="~/assets/images/nipa.png" class="w-1/2 md:max-w-sm p-8 mx-auto" />
  </section>
